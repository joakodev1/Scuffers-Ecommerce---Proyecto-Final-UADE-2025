...
# En desarrollo (DEBUG=True) estas opciones no se aplican fuerte.
# En producción (DEBUG=False) se vuelven estrictas.
if not DEBUG:
    # Obligar a usar HTTPS
    SECURE_SSL_REDIRECT = False           # 👈 DESACTIVADO
...
# Protección básica siempre, incluso en dev
X_FRAME_OPTIONS = "DENY"  # nadie puede embeber tu sitio en un iframe
SECURE_REFERRER_POLICY = "strict-origin-when-cross-origin"

# --- LOGGING / AUDITORÍA BÁSICA ---
